...
namespace CloudStack.Net
{
    ...
    {
        public AsyncJobResponse DeleteIso(DeleteIsoRequest request) => Proxy.Request<AsyncJobResponse>(request);
        public Task<AsyncJobResponse> DeleteIsoAsync(DeleteIsoRequest request) => Proxy.RequestAsync<AsyncJobResponse>(request);
    }
}
