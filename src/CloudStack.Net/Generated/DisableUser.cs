...
namespace CloudStack.Net
{
    ...
    {
        public AsyncJobResponse DisableUser(DisableUserRequest request) => Proxy.Request<AsyncJobResponse>(request);
        public Task<AsyncJobResponse> DisableUserAsync(DisableUserRequest request) => Proxy.RequestAsync<AsyncJobResponse>(request);
    }
}
