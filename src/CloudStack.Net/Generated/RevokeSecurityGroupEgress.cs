...
namespace CloudStack.Net
{
    ...
    {
        public AsyncJobResponse RevokeSecurityGroupEgress(RevokeSecurityGroupEgressRequest request) => Proxy.Request<AsyncJobResponse>(request);
        public Task<AsyncJobResponse> RevokeSecurityGroupEgressAsync(RevokeSecurityGroupEgressRequest request) => Proxy.RequestAsync<AsyncJobResponse>(request);
    }
}
