...
namespace CloudStack.Net
{
    ...
    {
        public SuccessResponse DeleteSSHKeyPair(DeleteSSHKeyPairRequest request) => Proxy.Request<SuccessResponse>(request);
        public Task<SuccessResponse> DeleteSSHKeyPairAsync(DeleteSSHKeyPairRequest request) => Proxy.RequestAsync<SuccessResponse>(request);
    }
}
